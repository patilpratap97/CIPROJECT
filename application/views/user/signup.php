...
<?php if(isset($_COOKIE["firstname"])) { echo $_COOKIE["firstname"]; } ?>
...
<?php if(isset($_COOKIE["lastname"])) { echo $_COOKIE["lastname"]; } ?>
...
<?php if(isset($_COOKIE["emailid"])) { echo $_COOKIE["emailid"]; } ?>
...
<?php if(isset($_COOKIE["mobilenumber"])) { echo $_COOKIE["mobilenumber"]; } ?>
